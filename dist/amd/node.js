...
define(["require", "exports", './base-http-request', './node-fetch', './utils', './request', './header', './types', './base-http-request', './base-http-request'], function (require, exports, base_http_request_1, node_fetch_1, utils_1, request_1, header_1, types_1, base_http_request_2, base_http_request_3) {
    "use strict";
